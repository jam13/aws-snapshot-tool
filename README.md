...
Simply add a tag to each volume you want snapshots of, configure and install a cronjob for aws-snapshot-tool and you are off. It will even handle rolling snapshots on a hour, day, week and year so that you can setup the retention policy to suit.
...
- *Configure retention policy*: Configure how many hours, days, weeks, and month snapshots you want to retain
...
7. Decide how many versions of the snapshots you want for hour/day/week/month and change this in config.py
...
11. Install the script in the cron: 
		...
		# crontab -e
		5 * * * * /opt/aws-snapshot-tool/makesnapshots.py hour
		30 1 * * 1-6 /opt/aws-snapshot-tool/makesnapshots.py day
		30 2 * * 0 /opt/aws-snapshot-tool/makesnapshots.py week
